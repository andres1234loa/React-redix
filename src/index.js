...
import {Provider} from 'react-redux';//{Porviders} no permite encapsular  nuestros componentes por medio de un conect el cual va contener toda la informacion de store tranmitida a estos componentes y tener la informacion en cada uno de los componentes 
// Provider,createStore es para redux
import {createStore} from 'redux';
import reducer from './reduces'; 
import App from './router/App';

//initialStatel es nuestro estado inicial
const initialState={
          "user":{},
          "playing":{},
          "myList": [],
...
// reduce es la carpeta que biene importada
const store=createStore(reducer, initialState)    
ReactDom.render(
    //se va pasar o proveer un store, que viene esportado de store
